...
pkgdatadir = $(datadir)/naturalli
pkgincludedir = $(includedir)/naturalli
pkglibdir = $(libdir)/naturalli
pkglibexecdir = $(libexecdir)/naturalli
...
ACLOCAL = ${SHELL} /home/gabor/workspace/naturalli/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /home/gabor/workspace/naturalli/missing --run autoconf
AUTOHEADER = ${SHELL} /home/gabor/workspace/naturalli/missing --run autoheader
AUTOMAKE = ${SHELL} /home/gabor/workspace/naturalli/missing --run automake-1.11
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CORENLP = /home/gabor/workspace/nlp/projects/core/classes
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/gabor/workspace/naturalli/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_NAME = NaturalLI
PACKAGE_STRING = NaturalLI 2.0.0
PACKAGE_TARNAME = naturalli
PACKAGE_URL = 
...
STRIP = strip
VERSION = 2.0.0
abs_builddir = /home/gabor/workspace/naturalli
abs_srcdir = /home/gabor/workspace/naturalli
abs_top_builddir = /home/gabor/workspace/naturalli
abs_top_srcdir = /home/gabor/workspace/naturalli
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/gabor/workspace/naturalli/install-sh
javac_found = yes
...
EXTRA_DIST = README.md doxygen.conf \
             ...
             qry.jar run \
             build.xml \
             lib/corenlp-scala.jar lib/jaws.jar lib/postgresql.jar \
             lib/protobuf.jar \
             lib/test/hamcrest-core-1.3.jar lib/test/junit-4.11.jar \
             lib/test/scalatest_2.11-2.1.6.jar
...
# ((export classpath))
#  export CP=${JAVANLP}:${LIB}/corenlp-scala.jar:${LIB}/scripts/sim-1.0.jar:${LIB}/jaws.jar:${LIB}/trove.jar:${LIB}/protobuf.jar:${LIB}/postgresql.jar:${LIB}/scripts/gson-2.2.4.jar:${LIB}/demo/joda-time.jar:${LIB}/demo/javamail-1.4.5.jar:${LIB}/demo/servlet-api.jar:${LIB}/scripts/lucene-core-4.7.0.jar:${LIB}/scripts/lucene-analyzers-common-4.7.0.jar:${SCALA_HOME}/lib/config-1.2.0.jar
  export CP=${JAVANLP}:${LIB}/corenlp-scala.jar:${LIB}/scripts/sim-1.0.jar:${LIB}/jaws.jar:${LIB}/trove.jar:${LIB}/protobuf.jar:${LIB}/postgresql.jar:${LIB}/scripts/gson-2.2.4.jar:${LIB}/demo/joda-time.jar:${LIB}/demo/javamail-1.4.5.jar:${LIB}/demo/servlet-api.jar:${LIB}/scripts/lucene-core-4.7.0.jar:${LIB}/scripts/lucene-analyzers-common-4.7.0.jar:${SCALA_HOME}/lib/typesafe-config.jar
...
# (some targets)
src/edu/stanford/nlp/naturalli/Messages.java: src/Messages.proto
	$(MAKE) -C src edu/stanford/nlp/naturalli/Messages.java

src/naturalli_preprocess.jar: $(wildcard src/edu/stanford/nlp/naturalli/*.java) src/edu/stanford/nlp/naturalli/Messages.java
