...
import org.goobs.naturalli.Messages.Monotonicity
...
object Implicits {
  ...
  class Fn1(fn:()=>Unit) extends java.util.function.Function[Properties, AnyRef] {
    def apply(in: Properties): Object = { fn(); None }
  }
  class Fn2(fn:Properties=>Unit) extends java.util.function.Function[Properties, AnyRef] {
    def apply(in: Properties): Object = { fn(in); None }
  }

  implicit def fn2execInput1(fn:()=>Unit):java.util.function.Function[Properties, AnyRef] = new Fn1(fn)
  implicit def fn2execInput2(fn:Properties=>Unit):java.util.function.Function[Properties, AnyRef] = new Fn2(fn)
