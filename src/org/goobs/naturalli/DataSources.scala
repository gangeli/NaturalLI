...
import org.goobs.naturalli.Messages.{Fact, Query}
import edu.stanford.nlp.util.logging.Redwood.Util._

import scala.collection.JavaConversions._
import org.goobs.naturalli.TruthValue._
import edu.stanford.nlp.util.Execution
import java.sql.{ResultSet, Connection}
import org.goobs.naturalli.DataSource.DataStream
...
object FraCaS extends DataSource with Client {
  ...
  def main(args:Array[String]):Unit = {
    ...
    System.exit(startMockServer(() =>
      Benchmark.evaluateBenchmark(read(Props.DATA_FRACAS_PATH.getPath) filter isApplicable07, NatLog.hardNatlogWeights,
        subResults=List(
