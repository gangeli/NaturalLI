...
%%%%%%%%%%%%%%%%%%%
\def\title{A New Approach To Open IE}
\begin{frame}{\title}
...
\begin{frame}{\title}
\only<1>{\hh{Some strange, nuanced function:}}
\only<2>{\hh{An entailment function:}}
\only<3>{\hh{A \darkblue{natural logic} entailment function:}} \\
\vspace{1em}
...
%%%%%%%%%%%%%%%%%%%
\def\title{Natural Logic For Deletions}
