...
\begin{itemize}
  \item Split long sentences into short, entailed clauses.
\end{itemize}
\vspace{0.5em}
\pause
...
\def\title{Split Sentences Into Clauses}
\begin{frame}{\title}
\begin{tabular}{ll}
...
\begin{center}
  \only<1>{\treeBlank}
  \only<2>{\hspace{-0.45em}\treeEdge}
  \only<3>{\hspace{-0.9em}\treeSubj}
\end{center}
\end{frame}
