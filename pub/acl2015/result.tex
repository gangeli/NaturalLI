...
\hline
Our System (no nominals)      & 59.6          & 14.1          & 22.7 \\
$~~$ + Nominal Rels           & 63.6          & 8.6           & 15.2 \\
$~~$ + Alt. Name              & 56.1          & 18.0          & 27.3 \\
$~~$ + Alt. Name + Website    & 57.0          & \textbf{18.8} & \textbf{28.3} \\
\hline
\end{tabular}
\end{center}
...
This suggests that the model is extracting multiple instances of a bad
  relation, which pushes the KBP confidence high.
This is likely due to a systematic error in the system, likely in the
  clause splitting.
...
After this dip, however, our system achieves both higher precision
