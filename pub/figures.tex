...
\def\teaserPremises{
  ...
  \node[right = of kittens] {\huge{$\dots$}};
}
      ...
      child {
        ...
        child {
          ...
          child {
            ...
            edge from parent [goodPath] node[below] {\rotatebox{90}{\Large{$\Rightarrow\lnot$}}}
          }
          edge from parent [goodPath] node[below] {\rotatebox{90}{\Large{$\Rightarrow$}}}
        }
        edge from parent [goodPath] node[below] {\rotatebox{90}{\Large{$\Rightarrow$}}}
      }
      edge from parent [goodPath] node[below] {\rotatebox{90}{\Large{$\Rightarrow$}}}
      ...
      child {
        ...
        child {
          ...
          child {
            ...
            edge from parent [goodPath] node[below] {\rotatebox{90}{\Large{\valid}}}
          }
          edge from parent [goodPath] node[below] {\rotatebox{90}{\Large{\valid}}}
        }
        edge from parent [goodPath] node[below] {\rotatebox{90}{\Large{\valid}}}
      }
      edge from parent [goodPath] node[below] {\rotatebox{90}{\Large{\invalid}}}
    };
  \teaserPremises
  \end{tikzpicture}
}
...
\newcommand\teaserFullDerivation{
  ...
  \node[fact] {\w{No carnivores eat animals?}}
    child {
      ...
      edge from parent [goodPath] node[above] {$\rotatebox{340}{\Large{\invalid}}$}
    }
    child {
      node[fact] {\w{No \textbf{cats} \\ eat animals}} 
      child {
...
%            child foreach \x in {1,2,3,4} {}
        ...
        edge from parent node[above,shift={(-1 ex,0 ex)}] {$\rotatebox{-56}{\Large{\valid}}$}
      }
      child {
        node[fact] {$\dots$}
      }
      edge from parent node[below] {$\rotatebox{90}{\Large{\valid}}$}
    }
    child {
      node[fact] {$\dots$}
    };
...
\newcommand\exampleTree[3]{\exampleTreeImpl{#1}{#2}{#3}{fact}}
\newcommand\exampleTreeEnd[3]{\exampleTreeImpl{#1}{#2}{#3}{sink}}

\def\exampleStepOne{\exampleTree{No carnivores eat animals}
                                {\textbf{The} carivores eat animals}
                                {No \textbf{cats} eat animals}}
\def\exampleStepTwo{\exampleTree{The carivores eat animals}
                                {The \textbf{feline} eats animals}
                                {\textbf{All} carnivores eat animals}}
\def\exampleStepThree{\exampleTree{The feline eats animals}
                                  {The \textbf{cat} eats animals}
                                  {The cat eats \textbf{chordate}}}
\def\exampleStepFour{\exampleTree{The cat eats animals}
                                 {The cat eats \textbf{chordates}}
                                 {The \textbf{kitty} eats animals}}
\def\exampleStepFive{\exampleTree{The cat eats chordates}
                                 {The cat eats \textbf{mice}}
                                 {The cat eats \textbf{dogs}}}
\def\exampleStepSix{\exampleTreeEnd{The cat eats mice}
...
\def\exampleInsertions{\exampleTree{The cat ate mouse?}
                                   {The cat ate \textbf{a} mouse}
