...
(a) & \includegraphics[scale=0.27]{../img/monotonicity_lex_all.pdf} \\
(b) &\includegraphics[scale=0.27]{../img/monotonicity_lex_meronymy.pdf}\\
%(a) & (b) & (c)
\end{tabular}
\end{center}
\caption{
...
Meronymy transitions are drawn from instances of the relation \w{location-contains} in Freebase \cite{key:2008bollacker-freebase}.
