...
A keyphrase is defined as a span of text which is either
  (1) a possibly empty sequence of adjectives and adverbs followed by a 
      sequence of nouns, and optionally followed by either \w{of} or the posessive
...
\\
  When you & |(hw)|\darkred{heat water} & on a & |(stove2)|\darkred{stove}, & 
    ...
    is & |(transferred2)|\darkred{transfered}. \\
};
...
The second constraint encodes a good aproximation for negation (see \reftab{operatormono});
  e.g., \textit{some}
...
The conspicous counterexamples to this is the operator pairs \w{all} and \w{no},
