...
For example, consider the following hypothesis (H) for the question
  \w{which part of a plant produces the seeds?}, and its supporting premise (P):
...
% Full example
For example, our hypothesis \w{a flower produces the seeds} can find
  a candidate premise \w{a flower grows seeds}, because \w{grow}
  entails \w{produce}.
This can then more easily match a known premise, \w{seeds grow inside a flower},
