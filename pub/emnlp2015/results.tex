...
\begin{center}
  ...
  \begin{tabular}{llcccccccc}
    ...
    $\mathsection$ & Category & Count & \multicolumn{2}{c}{Precision} & \multicolumn{2}{c}{Recall} & \multicolumn{3}{c}{Accuracy} \\
                   &          &       & \blue{N} & M08          & \blue{N} & M08          & \blue{N}  & M08 & N' \\
    \hline
...
\multicolumn{2}{l}{\a{Total}}                                                                                              
  ...
  \caption{
    ...
    N' is the original NaturalLI implementation in
...
%
\Subsubsection{aristo-train}{Training an Entailment Classifier}
...
% Results
%
\Subsubsection{aristo-results}{Experimental Results}
...
\textsc{Knowbot} is the dialogue system presented in \newcite{key:2015hixon-aristo}.
The held-out version used only additional facts from other question's dialogues;
