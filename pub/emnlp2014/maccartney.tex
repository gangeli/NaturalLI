...
For example, \w{mice} in \w{no cats eat mice} has downward polarity,
  whereas
...
%    $e_1 \equivalent  $ & $s_1 \equivalent  s_2$ & $s_1 \equivalent  s_2$ \\ 
     $e_1 \negate      $ & $s_1 \negate      s_2$ & $s_1 \negate      s_2$ \\ 
%    $e_1 \independent $ & $s_1 \independent s_2$ & $s_1 \independent s_2$
	\end{tabular}
	%(caption)
	\caption{
