...
\reftab{projectivity} outlines the (simplfied) table used for projecting
...
In fact, we can collapse the join table in \reftab{join} to make use
  of only these three states losslessly.

\todo{finish writing me!}
