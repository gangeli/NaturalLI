...
\begin{center}
  ...
  \begin{tabular}{|l|l|c|cc|cc|ccc|}
    ...
    1 & \a{Quantifiers}  & \a{44} & \a{\blue{91 }}  & \a{95}  & \a{\blue{100}} & \a{100} & \a{\blue{95}} & \a{84} & \a{97} \\
    ...
    5 & \a{Adjectives}   & \a{15} & \a{\blue{80 }}  & \a{71}  & \a{\blue{66 }} & \a{83}  & \a{\blue{73}} & \a{60} & \a{80} \\
    6 & \a{Comparatives} & \a{16} & \a{\blue{90 }}  & \a{88}  & \a{\blue{100}} & \a{89}  & \a{\blue{87}} & \a{69} & \a{81} \\
