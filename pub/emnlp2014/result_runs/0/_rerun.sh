...
mkdir -p /juice/scr20/scr/angeli/workspace/naturalli-emnlp/runs/0/_rerun
# Run Program
'java'\
	...
	'-search.allowlookup' 'true'\
	'-evaluate.model' 'models/ConceptNet-save/offline.tab'\
	'-log.file' '/juice/scr20/scr/angeli/workspace/naturalli-emnlp/runs/0/_rerun/redwood.log'