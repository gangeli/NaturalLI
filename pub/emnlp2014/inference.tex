...
This approach is efficient over a large database of 300 million entries
  ...
  lexical items.
The motivation in prior work for these sorts of \textit{fuzzy} matches --
...
In addition, our search must keep
  track of some additional information to ensure efficiency.
