...
import org.goobs.naturalli.Messages.{Inference, Fact, Query}
...
object RegressionTest extends Client {
  ...
  def runClient(weights:WeightVector):Int = {
    ...
    val reader = IOUtils.getBufferedReaderFromClasspathOrFileSystem("org/goobs/naturalli/regressions_natlog.dat")
